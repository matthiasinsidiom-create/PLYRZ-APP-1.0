      ...
      <div className="max-w-5xl mx-auto p-6 space-y-12">
          ...
          <div className="flex-1 space-y-10 w-full pt-4">
                  ...
                  {latestChange && (
                    <div className="flex items-center gap-4 bg-white/5 px-4 py-2 rounded-2xl border border-white/10 backdrop-blur-md">
                      <div className="text-center">
                        <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Prev</div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-2xl text-center border-emerald-500/20">
                <div className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest mb-1">Best</div>
              ...
              <div className="bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-2xl text-center border-red-500/20">
                <div className="text-[10px] font-bold text-red-500 uppercase tracking-widest mb-1">Worst</div>
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-black italic uppercase tracking-tight">Rating Progression</h2>
            </div>
          </div>
          ...
          <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-3xl h-[300px] w-full">
            {history.length > 1 ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-zinc-500 space-y-2">
                ...
                <p className="text-sm font-medium">Not enough match data for chart.</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black italic uppercase tracking-tight">Last Matches</h2>
          </div>
            ...
            {history.length > 0 ? (
              history.map((item) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-6"
                >
                  <div className="flex items-center gap-6 w-full sm:w-auto">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${item.delta_overall >= 0 ? 'bg-emerald-500/10' : 'bg-red-500/10'}`}>
                      {item.delta_overall >= 0 ? (
                        <TrendingUp className={`w-6 h-6 ${item.delta_overall > 0 ? 'text-emerald-500' : 'text-zinc-500'}`} />
                      ) : (
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-black italic uppercase tracking-tight text-white">
                        {item.fixtures?.home_team?.name} vs {item.fixtures?.away_team?.name}
                      </div>
                      <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest flex items-center gap-1.5 mt-1">
                  ...
                  <div className="flex items-center gap-8 w-full sm:w-auto justify-between sm:justify-end">
                    <div className="text-center sm:text-right">
                      <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1">Change</div>
                    ...
                    <div className="text-center sm:text-right">
                      <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1">New OVR</div>
              ...
              <div className="py-12 text-center bg-white/5 border border-dashed border-white/10 rounded-3xl">
                ...
                <p className="text-zinc-500 font-medium">No match history found.</p>
              </div>
            )}
          </div>
        </section>
